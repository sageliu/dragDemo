  ...
  $.fn.wheelmenu = function(options){
    ...
    return this.each(function(){
      ...
      if (settings.trigger == "hover") {
        ...
        console.log(this.whenDragging);
        this.whenDragging(function(params){
          var style = el.get(0).style;
          var elementXPosition = parseInt(style.left, 10);
          var elementYPosition = parseInt(style.top, 10);
          var elementNewXPosition = elementXPosition + params.offsetX;
          var elementNewYPosition = elementYPosition + params.offsetY;
        ...
        button.on("mousedown",function(e){
          ...
          console.log(e);
          e.preventDefault();
          if([e.pageX, e.pageY].equals(currentPos)){
              // click logic
              if (el.css('visibility') == "visible") {
                el.hideIcon(button, settings);
              } else {
                // button.animate({'right':'110px'},function(){
                //   el.showIcon(button, settings);
                // });
                button.css({'right':'110px'});
                el.showIcon(button, settings);
              }
          }
